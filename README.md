...
```
dotnet add package ToennVaot.Components.Core --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Api --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Api.Exceptions --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Api.Extensions --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.CoreApi.Interfaces --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Api.Models --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Exceptions --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Extensions --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Interfaces --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Models --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Models.Interfaces --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Security --version 1.0.10
```
...
```
dotnet add package ToennVaot.Components.Core.Web --version 1.0.10
```
